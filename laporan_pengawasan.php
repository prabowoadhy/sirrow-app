...
if (isset($_GET['mulai']) && $_GET['mulai']!=="") {
  // code...
  $sqlSub = " where `tb_pekerjaan`.`tanggal` BETWEEN '".$_GET['mulai']."' AND '".$_GET['sampai']."'";
  $notif = "Per Tanggal ".Indonesia2Tgl($_GET['mulai'])." hingga ". Indonesia2Tgl($_GET['sampai'])."";
} else {
  $sqlSub ="ORDER BY `tb_pekerjaan`.`tanggal` ASC";
  $notif = "";
}
 ...
 ?>
  ...
  <body style="background-color:#eee;">
    ...
    <table width="100%" border="1px #000 solid" cellspacing="1" cellpadding="4" class="table-print">
      ...
      include_once "library/inc.connection.php";
      include_once "library/inc.library.php";
      $mySql = "SELECT * from tb_pekerjaan $sqlSub";
